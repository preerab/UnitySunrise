...
public class UnityHelloWorldSCM
{
	...
	public UnityHelloWorldSCM() throws Exception {
	}

	//
		//try
		//{//
			//SpringApplication.run(UnityHelloWorldSCM.class);
	...
	//	String reqBody =  jtoken.getJToken(svcUsername, svcPassword);
		//String reqBody = "{\"Username \":\"SMART-8707-smartcosmo-test\",\"Password\":\"Sm4Rtr@et%ahN8l7gyF0%Ts1@rt-6!\"}";
	...
	//TODO : Modify to Spring resource - create applications.properties and use @Value annotations
